...
{/* Refer to the [Advanced Usage](/docs/advanced-usage) section for more details. */}
...
{/* Refer to the [Advanced Usage](/docs/advanced-usage) section for examples. */}
...
{/* Refer to the [Advanced Usage](/docs/advanced-usage) section for tips and examples. */}
